		...
		if (this.state.editing) {
			return (
				<div className="participant-row-container participant-editing">
					<input className="participant name" onChange={(e) => this.changeParticipantData('name', e.target.value)} defaultValue={this.props.participant.name}/>
					<input className="participant email" onChange={(e) => this.changeParticipantData('email', e.target.value)} defaultValue={this.props.participant.email}/>
					<input className="participant phone" onChange={(e) => this.changeParticipantData('phone', e.target.value)} defaultValue={this.props.participant.phone}/>
			...
			return (
				<div className="participant-row-container">
					<div className="participant name">{this.props.participant.name}</div>
					<div className="participant email">{this.props.participant.email}</div>
					<div className="participant phone">{this.props.participant.phone}</div>
					<div className="action-button-container">
